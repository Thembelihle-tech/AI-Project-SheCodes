...
function generatePoem(event){
    ...
    let context = "You are a romantic Poem writer. Output ONLY a five line poem. Do NOT include introductions, explanations, markdown, or code blocks. Use <br> tags between lines.";
